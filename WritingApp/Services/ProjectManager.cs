...
public class ProjectManager
{
    ...
    public ProjectManager()
    {
        ...
        // Combine it with "WritingApp\Projects" to create our project storage location
        _projectsDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "WritingApp", "Projects");
    ...
    public List<string> GetProjectList()
    {
        ...
        return projectFiles.Select(Path.GetFileNameWithoutExtension).ToList();
    }
